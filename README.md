...
- [ResearchState (Shared Workflow State)](#researchstate-shared-workflow-state)
  - [State Categories](#state-categories)
    - [User Input & Planning](#user-input--planning)
    - [Constraints & Query Structure](#constraints--query-structure)
    - [Tool Execution & Retrieval](#tool-execution--retrieval)
...
- [LangGraph Architecture Overview](#langgraph-architecture-overview)
  ...
  - [Core Concept](#core-concept)
    - [Shared State](#shared-state-researchstate)
